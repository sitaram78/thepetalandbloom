...
export default function About() {
  return (
    <div className="bg-parchment-50">
      <PageHeader
        label="About"
        title={<>A little studio built around thoughtful gifting</>}
        subtitle="The Petal & Bloom is a small handmade brand focused on creating meaningful, long-lasting gifts — one stitch at a time."
        ...
        <div className="container-lux max-w-3xl">
          <Reveal>
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-ink leading-relaxed font-serif text-2xl mb-8">
                We are a small handmade brand. Not a big company, not a factory, not a marketplace.
              </p>
              <p className="text-ink-light leading-relaxed mt-6 text-lg">
              ...
              <p className="font-serif text-2xl text-ink leading-relaxed mt-10 italic border-l-4 border-rose pl-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mt-12">
            {[
              ...
              <Reveal key={i} delay={i * 100}>
                <div className="glass-panel p-8 rounded-sm border border-silk shadow-soft h-full">
                  <div className="w-12 h-12 rounded-full bg-silk flex items-center justify-center mb-5 text-rose">
            ...
            {[
              ...
              <Reveal key={i} delay={i * 80}>
                <div className="group cursor-default">
                  <div className="aspect-[3/4] overflow-hidden rounded-sm shadow-soft transition-transform duration-700 group-hover:scale-[1.02]">
                    <img src={step.img} alt={step.label} loading="lazy" className="w-full h-full object-cover" />
                  </div>
                  <p className="text-sm text-ink-light mt-4 text-center font-serif text-lg">{step.label}</p>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      {/* CTA */}
      <section className="py-16 lg:py-20 bg-forest relative overflow-hidden">
        ...
        <div className="container-lux relative z-10 text-center">
          <Reveal>
            <h2 className="heading-serif text-3xl lg:text-5xl text-parchment-50 mb-6">
              Let's make something for you.
            </h2>
            <p className="text-parchment-100/70 max-w-md mx-auto mb-10 text-lg font-light">
              Browse our blooms, start a custom order, or just say hello on WhatsApp.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/shop" className="btn-primary bg-parchment-50 text-forest hover:bg-parchment-100 px-10 py-4">
                Shop the blooms <ArrowRight size={18} />
              </Link>
              <WhatsAppButton
                message={generalEnquiryMessage()}
                label="Say hello on WhatsApp"
                variant="outline"
                className="!border-parchment-100/30 !text-parchment-50 hover:!bg-parchment-50 hover:!text-forest px-10 py-4"
              />
            </div>
          </Reveal>
        </div>
